...
class HeroAttackControllerTest {
    ...
    @Test
    void testShowHeroAttackBoard() {
        HeroAttackController heroAttackController = new HeroAttackController(userService, turnService, gameService,
            playerService, advise, cacheManager, deckService,
            new AbilityService(mock(AbilityRepository.class), mock(AbilityInGameRepository.class)));
        MockHttpSession mockHttpSession = new MockHttpSession();
        ModelMap modelMap = new ModelMap();
        assertEquals("turns/attackPhase",
            heroAttackController.showHeroAttackBoard(mockHttpSession, modelMap, new MockHttpServletRequest()));
    }


    @Test
    void testAttackEnemy() throws NoCurrentPlayer, WithOutAbilityException, WithOutEnemyException {
        ...
        HeroAttackController heroAttackController = new HeroAttackController(userService, turnService, gameService,
            ...
            new AbilityService(mock(AbilityRepository.class), mock(AbilityInGameRepository.class)));
        MockHttpSession mockHttpSession = new MockHttpSession();
        assertEquals("redirect:/heroAttack",
            heroAttackController.attackEnemy(mockHttpSession));
    }
